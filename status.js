...
const statusIcons = {
  online: `<svg width="${iconWidth}" height="${iconHeight}" viewBox="0 0 1 1"><defs><mask id="svg-mask-status-online" maskContentUnits="objectBoundingBox" viewBox="0 0 1 1"><circle fill="white" cx="0.5" cy="0.5" r="0.5"></circle></mask></defs><rect fill="#23a559" width="1" height="1" mask="url(#svg-mask-status-online)"></rect></svg>`,
  idle: `<svg width="${iconWidth}" height="${iconHeight}" viewBox="0 0 1 1"><defs><mask id="svg-mask-status-idle" maskContentUnits="objectBoundingBox" viewBox="0 0 1 1"><circle fill="white" cx="0.5" cy="0.5" r="0.5"></circle><circle fill="black" cx="0.25" cy="0.25" r="0.375"></circle></mask></defs><rect fill="#f0b232" width="1" height="1" mask="url(#svg-mask-status-idle)"></rect></svg>`,
  dnd: `<svg width="${iconWidth}" height="${iconHeight}" viewBox="0 0 1 1"><defs><mask id="svg-mask-status-dnd" maskContentUnits="objectBoundingBox" viewBox="0 0 1 1"><circle fill="white" cx="0.5" cy="0.5" r="0.5"></circle><rect fill="black" x="0.125" y="0.375" width="0.75" height="0.25" rx="0.125" ry="0.125"></rect></mask></defs><rect fill="#f23f43" width="1" height="1" mask="url(#svg-mask-status-dnd)"></rect></svg>`,
  offline: `<svg width="${iconWidth}" height="${iconHeight}" viewBox="0 0 1 1"><defs><mask id="svg-mask-status-offline" maskContentUnits="objectBoundingBox" viewBox="0 0 1 1"><circle fill="white" cx="0.5" cy="0.5" r="0.5"></circle><circle fill="black" cx="0.5" cy="0.5" r="0.25"></circle></mask></defs><rect fill="#80848e" width="1" height="1" mask="url(#svg-mask-status-offline)"></rect></svg>`,
};
  ...
  if (data.spotify && data.spotify.timestamps) {
    ...
    html += `<div style="display: grid; grid-template-columns: 16px 20px 1fr; align-items: center; gap: 8px; margin-bottom: 5px;">
                    ...
                    <div style="display: flex; gap: 8px; align-items: center;">
                        <a href="https://open.spotify.com/track/${sp.track_id}" target="_blank">${sp.song}</a>
